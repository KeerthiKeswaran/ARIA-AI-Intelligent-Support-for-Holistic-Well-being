...
import RelocationAdvice from './RelocationAdvice';
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-teal-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <button
          ...
          className="fixed bottom-5 right-5 w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300"
        >
          <svg
            className="w-8 h-8"
            fill="none"
